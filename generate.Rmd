...
We'll take advantage of Uber's [https://www.uber.com/blog/h3](H3) hexagonal hierarchical spatial index using the R package [h3](https://crazycapivara.github.io/h3-r/articles/h3.html) with the following points:
