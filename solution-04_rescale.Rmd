...
```{r area: 30% ; targets: 1; weights: 1}
s_name <- "area: 30% ; targets: 1; weights: 1"
```
## Solution - `r s_name`
...
```{r area: 30% ; targets: 1; weights: spp*5}
s_name <- "area: 30% ; targets: 1; weights: spp*5"
```
## Solution - `r s_name`
...
```{r area: 30%; targets: 99% of max; weights: spp*5}
s_name <- "area: 30%; targets: 99% of max; weights: spp*5"
```
...
```{r area: 30%; targets: 90% of max; weights: spp*5}
s_name <- "area: 30%; targets: 90% of max; weights: spp*5"
```
## Solution - `r s_name`
