...
```{r 30% area; targets 1; equal weights}
...
```{r 30% area; targets 1; spp*5 weights}
...
```{r, 30% area; targets 99% of max; spp*5 weights}
...
```{r 30% area; targets 90% of max; spp*5 weights}
