...
# add indices
dbSendQuery(con, glue(
  "CREATE UNIQUE INDEX IF NOT EXISTS hex_hexid_idx ON hex (hexid);"))
dbSendQuery(con, glue(
  "CREATE UNIQUE INDEX IF NOT EXISTS sol_hex_idx ON sol_hex (sid, hexid);"))
```
